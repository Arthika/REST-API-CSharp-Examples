...
namespace CancelOrder
{
    ...
    class CancelOrder
    {
        ...
        private static String URL = "/cancelOrder";
        ...
        public static void Exec()
        {
            ...
            using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
            {
                ...
                request.cancelOrder = new cancelOrderRequest(user, token, new List<string> { order1, order2 });
                streamWriter.WriteLine(serializer.Serialize(request));
            }
                ...
                try
                {
                    while ((line = streamReader.ReadLine()) != null)
                    {
                        ...
                        if (response.cancelOrderResponse != null)
                        {
                            ...
                            {
                                Console.WriteLine("Message from server: " + response.cancelOrderResponse.message);
                            }
                        }
                    }
                }
